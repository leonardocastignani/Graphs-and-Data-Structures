...
/**
 * Test class for the methods of the KruskalMSP class.
 * 
...
class KruskalMSPTest {
    ...
    final void exceptionsTest() {
        ...
        Graph<String> x = new AdjacencyMatrixUndirectedGraph<String>();
        GraphNode<String> A = new GraphNode<String>("A");
        x.addNode(A);
        GraphNode<String> B = new GraphNode<String>("B");
        x.addNode(B);
        GraphNode<String> C = new GraphNode<String>("C");
        x.addNode(C);
        x.addEdge(new GraphEdge<String>(A, B, false, 0));
        x.addEdge(new GraphEdge<String>(B, C, false, -2));
    ...
    final void testFullyConnectedGraph() {
        ...
        gr.addEdge(new GraphEdge<String>(b, c, false, 2));

        KruskalMSP<String> alg = new KruskalMSP<String>();

        Set<GraphEdge<String>> result = new HashSet<GraphEdge<String>>();
        result.add(new GraphEdge<String>(a, b, false, 1));
        result.add(new GraphEdge<String>(b, c, false, 2));

        assertEquals(result, alg.computeMSP(gr), "Il risultato non corrisponde "
        		     + "all'MST del grafo completamente connesso.");
    }
    ...
    final void testSparseGraph() {
        ...
        gr.addEdge(new GraphEdge<String>(b, c, false, 1));
        gr.addEdge(new GraphEdge<String>(c, d, false, 4));

        KruskalMSP<String> alg = new KruskalMSP<String>();

        Set<GraphEdge<String>> result = new HashSet<GraphEdge<String>>();
        result.add(new GraphEdge<String>(a, b, false, 3));
        result.add(new GraphEdge<String>(b, c, false, 1));
        result.add(new GraphEdge<String>(c, d, false, 4));
